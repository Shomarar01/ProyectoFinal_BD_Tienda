...
La base de datos fue sometida a una validaci\'on rigurosa ejecutando consultas y simulando escenarios de error mediante el comando \texttt{CALL}, para comprobar que el sistema realmente soporta el uso diario de una tienda online.

\subsection{Resultados de consultas con datos de prueba}
Al realizar las consultas que construimos en la Fase 3 con los datos de prueba ingresados, el sistema nos devolvi\'o exactamente la informaci\'on que esper\'abamos. Aqu\'i detallamos los resultados:
...
+----+-------------+-----------+------+---------------------+---------------------+---------+-------+------+----------+
|  1 | SIMPLE      | productos | ref  | idx_producto_nombre | idx_producto_nombre | 452     | const |    1 |   100.00 |
+----+-------------+-----------+------+---------------------+---------------------+---------+-------+------+----------+
\end{verbatim}
